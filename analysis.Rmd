...
# Visualizing how much money an applicant can get if they have flood insurance vs. =vs. FEMA's individual assistance program. Using a 2x2 data frame created in Excel using above calculations
```{r}
...
```{r}
library(ggplot2)
ggplot(viz, aes(fill=Program, y=Amount, x=Storms)) + 
