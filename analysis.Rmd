...
# Visualizing how much money an applicant can get if they have flood insurance vs. =vs. FEMA's individual assistance program. Using a data frame created in Excel using above calculations
```{r}
